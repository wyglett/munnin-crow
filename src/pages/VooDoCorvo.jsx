      ...
      <div className="max-w-4xl mx-auto px-6">
        ...
        {aba === "trilha" && (
          <div className="space-y-3 pb-10">
            ...
            <div className={`mt-4 p-4 rounded-xl text-xs ${isLight ? "bg-amber-50 border border-amber-200 text-amber-700" : "bg-amber-900/20 border border-amber-700/30 text-amber-300"}`}>
