...
import { Download, Loader2, Plus, Pencil, Trash2, FolderOpen, UserPlus, Users, BookOpen, ChevronDown, ChevronRight, Info, TrendingUp, Brain, Zap, Moon, Sun, FileText, BarChart3, Bell } from "lucide-react";
            ...
            {activeTab === "editais" && (
              <div className="space-y-5">
                <div className="flex flex-wrap gap-2">
                  ...
                  <Button onClick={openNew} variant="outline" className="border-white/20 hover:bg-white/10 text-slate-200 hover:text-white"><Plus className="w-4 h-4 mr-2" /> Novo</Button>
                </div>
